...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `How To Play ${game.name} | ${data.series.name}`,
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #0a0a0a 100%)' }}>
      ...
      <div style={{ maxWidth: '48rem', margin: '0 auto', padding: '6rem 1rem 3rem' }}>
        ...
        <div style={{
          ...
          <span>/</span>
          <Link href={`/discover/games/${series}`} style={{ color: game.color, textDecoration: 'none' }}>
            {seriesInfo.name}
          </Link>
          <span>/</span>
          <Link href={`/discover/games/${series}/${game.slug}`} style={{ color: game.color, textDecoration: 'none' }}>
            {game.name}
          </Link>
          <span>/</span>
        ...
        <div style={{
          ...
          >
            View All {seriesInfo.name} Games
          </Link>
        </div>
