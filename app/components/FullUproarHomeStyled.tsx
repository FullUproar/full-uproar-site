    ...
    <div style={styles.container}>
      <Navigation />
            ...
            {!isMobile && (
              ...
              <a href="/chaos" style={styles.navLink}>CHAOS</a>
              <a href="/cult" style={styles.navLink}>CULT</a>
        ...
        {isMobile && isMenuOpen && (
          <div style={{
            ...
            <a href="/chaos" style={{...styles.navLink, display: 'block', padding: '0.5rem'}} onClick={() => setIsMenuOpen(false)}>CHAOS</a>
            <a href="/cult" style={{...styles.navLink, display: 'block', padding: '0.5rem'}} onClick={() => setIsMenuOpen(false)}>CULT</a>
